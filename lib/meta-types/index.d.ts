...
export declare type MetaType = AnyType | NeverType | ConstType | EnumType | PrimitiveType | BrandedPrimitiveType | ArrType | TupleType | ObjectType | UnionType | IntersectionType | ExclusionType | ErrorType;
...
export { Any, Never, Const, Enum, Primitive, BrandedPrimitive, Arr, Tuple, Object, Union, Intersection, Exclusion, Error, };
